...
| <a name="input_region"></a> [region](#input\_region) | Cluster region to be used to helm controller | `string` | n/a | yes |
| <a name="input_tags"></a> [tags](#input\_tags) | Tags to be added to AWS resources | `map(string)` | n/a | yes |
| <a name="input_vpc_id"></a> [vpc\_id](#input\_vpc\_id) | Network VPC ID to be used to helm controller | `string` | n/a | yes |
